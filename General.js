...
france({ nomCom: "developer", categorie: "General", reaction: "🚘" }, async (dest, zk, commandeOptions) => {
    ...
    const devs = [
      ...
      { nom: "᚛Kamunyaro᚜", numero: "263779715613" },
      // Ajoute d'autres développeurs ici avec leur nom et numéro
    ];

    let message = "Oyaah 👊\n *Welcome to P-GLO-TEQ-Md!*\n\n*💠━━💠CREATOR INFO💠━━💠*\n\n\n *◇NAME: _Kamunyaro Tanaka_*\n*◇AGE: 18*\n*◇LOCATION: _On Earth_*\n*◇BELIEVER: YES ✅*\n*◇FRIENDLY: YES ✅*\n*◇EGOISTIC: _YEEES ✅_*\n*◇FAV MOVIE: _ONE EYE_*\n*◇INSTAGRAM: https://instagram.com/kamz_tech_official*\n*◇Twitter: https://twitter.com/kamz_parsley*\n\n______________________________\n\n*🚖KEEP USING P-GLO-TEQ-MD🚖*\n\n\n_The following are my contacts_:\n:";
...
france({ nomCom: "support", categorie: "General" }, async (dest, zk, commandeOptions) => {
  ...
  await zk.sendMessage(auteurMessage,{text : `https://wa.me/263779715613`},{quoted :ms})
